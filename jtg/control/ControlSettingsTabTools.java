/*
ControlSettingsTabTools.java by Geist Alexander 
...
import presentation.settings.GuiSettingsTabTools;
import presentation.settings.GuiTabSettings;

public class ControlSettingsTabTools extends ControlTabSettings implements ActionListener, KeyListener  {

    GuiTabSettings settingsTab;
    
    public ControlSettingsTabTools (GuiTabSettings tabSettings) {
    ...
    private GuiSettingsTabTools getTab() {
        return this.getSettingsTab().getSettingsTabTools();
    }
}
