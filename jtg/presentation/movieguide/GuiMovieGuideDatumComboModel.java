 ...
 */
public class GuiMovieGuideDatumComboModel extends DefaultComboBoxModel { //implements ComboBoxModel {
	
	ControlMovieGuideTab control;
	
	public GuiMovieGuideDatumComboModel(ControlMovieGuideTab ctrl) {
		this.setControl(ctrl);
	}
	
	public Object getElementAt(int index) {		
		return this.getControl().getDatumList().toArray()[index];		
	}

	public int getSize() {
		return this.getControl().getDatumList().size();
	}
