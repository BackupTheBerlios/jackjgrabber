 ...
 */
public class GuiMovieGuideSenderComboModel extends DefaultComboBoxModel { //implements ComboBoxModel {
	
	ControlMovieGuideTab control;
	
	public GuiMovieGuideSenderComboModel(ControlMovieGuideTab ctrl) {
		this.setControl(ctrl);
	}
	
	public Object getElementAt(int index) {		
		return this.getControl().getSenderList().toArray()[index];		
	}
