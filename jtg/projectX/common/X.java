...
import projectX.audio.Audio;
import projectX.audio.AudioFrameConstants;
import projectX.audio.CRC;
import projectX.audio.MPAC;
import projectX.audio.MPAD;
import projectX.audio.RIFFHeader;
import projectX.gui.AboutBox;
import projectX.gui.BRMonitor;
import projectX.gui.HexViewer;
import projectX.gui.Html;
import projectX.gui.LogArea;
import projectX.gui.UISwitchListener;
import projectX.io.IDDBufferedOutputStream;
import projectX.io.RawInterface;
import projectX.io.Scan;
import projectX.io.StandardBuffer;
import projectX.subtitle.BMP;
import projectX.subtitle.Bitmap;
import projectX.subtitle.SubPicture;
import projectX.subtitle.Teletext;
import projectX.subtitle.TeletextPageMatrix;
import projectX.thirdparty.Chapters;
import projectX.thirdparty.D2V;
import projectX.thirdparty.Ifo;
import projectX.thirdparty.TS;
import projectX.video.MPVD;
import projectX.video.PatchPanel;
import projectX.video.Preview;
import projectX.video.PreviewObject;
...
public static JPanel main(String[] args)
{
	...
	TextArea.append(version[0]+"/"+version[1]+" "+version[2]);
					...
					if (lastpage_match)
					{
						...
						if (write)  //buffered page can be written
						{
							...
							while (true)
							{
								...
								case 3:  // SUB
									print_buffer.print( "{" + ( Long.parseLong( write_buffer.get("in_time").toString()) / videoframerate) + "}");
									print_buffer.print( "{" + ( Long.parseLong( write_buffer.get("out_time").toString()) / videoframerate) + "}");
									break;
